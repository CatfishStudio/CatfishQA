package catfishqa.admin.teamUserNew 
{
	...
	public class TeamUserNew extends NativeWindowInitOptions 
	{
		...
		public function TeamUserNew(teamSelect:String) 
		{
			super();
		...
		{
			var sqlCommand:String = "INSERT INTO team_users "
								+ "(team_users_name, team_users_login, team_users_rights, team_users_groups_name) VALUES ("
								+ "'" + _textBox2.text + "', "
								+ "'" + _textBox3.text + "', "
								+ "'" + _comboBox5.selectedItem.data + "', "
								+ "'" + _comboBox4.selectedItem.label + "')";
