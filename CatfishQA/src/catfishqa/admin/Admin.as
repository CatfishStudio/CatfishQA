package catfishqa.admin 
{
	...
	public class Admin extends Sprite 
	{
		...
		private function adminShow():void
		{
			...
			_label6.text = "Тест-кейсы - раздел тест-кейсов относительно проекта. \nДанных раздел содержит перечень тест-кейсов определённого проекта."; 
			_label6.x = 250;
			_label6.y = 310;
			_label6.width = 500;
			_label6.height = 100;
			...
			_button7.label = "Чек-листы";
			_button7.x = 20; _button7.y = 355;
			_button7.width = 200;
			_button7.addEventListener(MouseEvent.CLICK, onButton7MouseClick);
			addChild(_button7);
			
			_label7.text = "Чек-листы - раздел чек-листов относительно пенктов тест-кейса. \nДанных раздел содержит перечень чек-листов определённых пунктов тест-кейса."; 
			_label7.x = 250;
			_label7.y = 350;
			_label7.width = 500;
			_label7.height = 100;
