...
namespace AdminQA.Forms
{
	...
	public partial class CreateConfig : Form
	{
		...
		public CreateConfig(MainForm parentForm)
		{
			//
		...
		void Button1Click(object sender, EventArgs e)
		{
			...
			for(int i = 0; i < richTextBox1.Text.Length; i++)
			{
				for(int iascii = 0; iascii < (table_ASCII.Length / 3); iascii++)
				{
					...
					{
						int dec = Convert.ToInt32(table_ASCII[iascii,1]) + 1;
						String hex = "";
						
						for(int j = 0; j < table_DecHex.Length; j++)
						{
							if(dec.ToString() == table_DecHex[j,0])
							{
								hex = table_DecHex[j,1];
								break;
							}
						}
						textincode += hex + " ";
		...
		void CreateConfigClosed(object sender, EventArgs e)
		{
		...
		private void Form1_Closing(Object sender, CancelEventArgs e) 
		{
       		if (!fileSave) {
          		e.Cancel = true;
          		MessageBox.Show("Вы не сохранили файл конфигурации.");
       		}
       		else {
          		e.Cancel = false;
          	}
